...
namespace Cli.AsciiChart
{
    ...
    {
        private const int NumberOfNonDataColumns = 2;
        ...
        private static string[][] CreateAndFill2dArray(double rows, int width, string fill)
        {
        ...
        private static IReadOnlyList<AxisLabel> GetYAxisLabels(double max, double range, double rows, Options options)
        {
        ...
        private static IReadOnlyList<double> GetYAxisTicks(double max, double range, double rows)
        {
        ...
        private static void ApplyYAxisLabels(string[][] resultArray, IReadOnlyList<AxisLabel> yAxisLabels, int columnIndexOfFirstDataPoint)
        {
        ...
        private static string ToString(string[][] resultArray)
        {
